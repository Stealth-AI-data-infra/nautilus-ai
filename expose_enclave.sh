...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:830325870418:secret:weather-api-key-5La31X --region us-east-1 | jq -r .SecretString)
